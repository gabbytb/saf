...
const DashboardArticlesDetails = ({ isLoggedIn }) => {
    ...
    useEffect(() => {
        ...
        const pageTitle = "Dashboard - Article Details", 
    ...
    console.log("SEARCH RESULTS WHILE VIEWING ARTICLE DETAILS:", data);

    const [totalBlogArticles, setTotalBlogArticles] = useState(null);
    ...
    const fetchData = async () =>  {
        ...
        .then((response) => {
            ...
            setData(allBlogPosts);
            setPageLimit(pagination?.postLimit);

            setTotalBlogArticles(pagination?.postsRecord);
                    ...
                    <div className="px-4 md:px-10 mx-auto w-full -m-24">                    
                        <div className="flex flex-wrap">
                            <div className="w-full px-4">
                                ...
                                {/* Article Details */}
                                <CardArticleDetails userId={userId} firstName={firstName} lastName={lastName} userEmail={userEmail} displayImg={displayImg} userBio={userBio} />
                                {/* Article Details */}
...
export default DashboardArticlesDetails;