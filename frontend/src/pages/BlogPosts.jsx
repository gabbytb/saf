        ...
        <div id="blogPostsWrapper">
            ...
            <main id="blogPostsID" className="container mx-auto">
                <div className="mx-12 lg:mx-16 mt-36 mb-28 grid">                     
                    <div className="mx-auto flex flex-col items-center px-12">  
                        ...
                        {/* POSTS LISTING */}    
                        {
                            allBlogPosts.length !== 0 ? 
                                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-16 gap-y-20 mx-auto sm:mx-8 lg:mx-16 flex-wrap sm:px-32">                                    
                                    {
