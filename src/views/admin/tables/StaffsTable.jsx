...
// components
import { CardAllApprovedStaffs, CardAllPendingStaffs, CardAllRejectedStaffs, TableDropdown, } from "../../../components";
...
export default function StaffsTable({ color, search, allStaffs }) {
