...
export default function CardAllStaffs({ color }) {
  ...
  useEffect(() => {
      if (activeDisplay === "allStaffs") {
          ...
          var timerID = setTimeout(fetchAllStaffs, 800);   // Delay execution of findAllStaffs by 1800ms
          return () => {
          ...
          <>
            <div
              ...
              <div id="staffsLinkID" className="flex flex-row gap-3 mt-8 mb-10 px-7">
                <Link className="allStaffs activeStaffView pt-3 pb-2 px-10 rounded-lg border mr-2 text-xl" onClick={() => setActiveDisplay("allStaffs")}>All</Link>
                <Link className="allApprovedStaffs pt-3 pb-2 px-10 rounded-lg border mr-2 text-xl" onClick={() => setActiveDisplay("allApprovedStaffs")}>Approved</Link>
                <Link className="allPendingStaffs pt-3 pb-2 px-10 rounded-lg border mr-2 text-xl" onClick={() => setActiveDisplay("allPendingStaffs")}>Pending</Link>
                <Link className="allRejectedStaffs pt-3 pb-2 px-10 rounded-lg border text-xl" onClick={() => setActiveDisplay("allRejectedStaffs")}>Rejected</Link>
              </div>
              {/* Users Navigation */}
