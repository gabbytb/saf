              ...
              <div
                ...
                >
                  ...
                  <div id="usersLinkID" className="flex flex-row gap-3 mt-8 mb-10 px-7">
                      <Link className="allUsers activeUserView pt-3 pb-2 px-10 rounded-lg border mr-2 text-xl flex flex-row gap-1" onClick={() => setActiveDisplay("allUsers")}>All <span className="texture"> ({ totalUsers })</span></Link>
                      <Link className="allApprovedUsers pt-3 pb-2 px-10 rounded-lg border mr-2 text-xl flex flex-row gap-1" onClick={() => setActiveDisplay("allApprovedUsers")}>Approved <span className="texture"> ({ totalApprovedUsers })</span></Link>
                      <Link className="allPendingUsers pt-3 pb-2 px-10 rounded-lg border mr-2 text-xl flex flex-row gap-1" onClick={() => setActiveDisplay("allPendingUsers")}>Pending <span className="texture"> ({ totalPendingUsers })</span></Link>
                      <Link className="allRejectedUsers pt-3 pb-2 px-10 rounded-lg border text-xl flex flex-row gap-1" onClick={() => setActiveDisplay("allRejectedUsers")}>Rejected <span className="texture"> ({ totalRejectedUsers })</span></Link>
                  </div>
                  {/* Users Navigation */}
